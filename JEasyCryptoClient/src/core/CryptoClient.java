...
public class CryptoClient implements ReaderObserver {
	 ...
	 */
	public String sendEncryptRequest(String method, String text, String key, String step) throws IOException {
		JSONObject request = new JSONObject();
		request.put("id", requestId++);
	 ...
	 */
	public String sendDecryptRequest(String method, String text, String key, String step) throws IOException {
		JSONObject request = new JSONObject();
		request.put("id", requestId++);
